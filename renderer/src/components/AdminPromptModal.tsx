...
export function AdminPromptModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-white/[.07] bg-zinc-900/95 p-6 text-zinc-100 shadow-2xl animate-in slide-in-from-top-4 duration-300 ease-out">
        ...
        <p className="text-sm text-zinc-400 mb-6">
          It's recommended to launch <span className="text-white font-medium">{gameName}</span> with administrator privileges for the best experience and to avoid potential compatibility issues.
        </p>
