...
export function GameLinuxConfigModal({ open, appid, gameName, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-lg rounded-2xl border border-border/60 bg-slate-950/98 shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="flex items-center gap-3 px-5 py-4 border-b border-border/40 bg-white/5">
            ...
            <>
              ...
              <div className="rounded-lg border border-border/40 bg-card/30 p-3 space-y-3">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {slsSteamGlobal !== null && (
                    <span className={`text-[10px] px-1.5 py-0.5 rounded-full border ${slsSteamGlobal.found ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30' : 'bg-muted/30 text-muted-foreground border-border/40'}`}>
        ...
        {/* Footer */}
        <div className="flex items-center justify-between gap-2 px-5 py-3 border-t border-border/40 bg-white/5">
