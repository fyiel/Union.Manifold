...
export function installBridge(): void {
  ...
  w.ucSources = {
    ...
    cancelQuery: (reqId: number) => call("sources_cancel", { reqId }),
  ...
  w.ucMods = {
    ...
    workshopSteamAccount: () => call("workshop_steam_account"),
    workshopSetSteamAccount: (username: string, password: string) => call("workshop_set_steam_account", { username, password }),
    workshopSteamGuardCode: (code: string | null) => call("workshop_steam_guard_code", { code }),
    onSteamGuardRequired: (cb: Cb) => on("mods:steam-guard-required", cb),
