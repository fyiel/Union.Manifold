...
fn browser_headers() -> HashMap<String, String> {
    [
        ...
        // Referer-less page fetches get bounced (303) to the steamrip
        // homepage, which has no download tokens — the hosts are
        // steamrip-affiliated, so any steamrip referer satisfies the check.
...
mod tests {
    ...
    fn page_requests_carry_steamrip_referer() {
        // bzzhr.to/buzzheavier.com bounce referer-less page fetches to the
        // steamrip homepage (303), which looks like a token-less page.
