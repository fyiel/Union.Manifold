...
pub const SOURCES: &[SourceMeta] = &[
    ...
    SourceMeta { id: "astralgames", name: "AstralGames", homepage: "https://astralgames.net" },
...
pub fn capabilities_for(id: &str) -> Capabilities {
    match id {
        ...
        "astralgames" => adapters::astralgames::capabilities(),
...
async fn adapter_query(id: &str, params: &QueryParams) -> Option<Vec<SourceGame>> {
    match id {
        ...
        "astralgames" => adapters::astralgames::query(params).await,
        _ => Some(Vec::new()),
    }
}
...
async fn adapter_search(id: &str, q: &str, limit: usize) -> Vec<SourceGame> {
    match id {
        ...
        "astralgames" => adapters::astralgames::search(q, limit).await,
        _ => Vec::new(),
    }
}
...
async fn adapter_detail(id: &str, slug: &str) -> Option<SourceGame> {
    match id {
        ...
        "astralgames" => adapters::astralgames::get_detail(slug).await,
        _ => None,
    }
}
...
async fn adapter_tags(id: &str) -> Vec<String> {
    match id {
        ...
        "astralgames" => adapters::astralgames::list_tags().await,
        _ => Vec::new(),
    }
}
